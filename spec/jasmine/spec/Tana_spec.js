...
describe('Tana', function() {
  var BIAS5, DI, EMA10, EMA20, EMA5, KDJ9, MA10, MA20, MA5, MACD5_10_9, RSI10, WR9, i, tana;
  ...
  BIAS5 = ((function() {
    ...
    return _results;
  })()).concat([-0.96, 3.68, 4.70, -0.57, -1.94, -2.22, -2.16, 1.72, -0.36, 3.06, -2.78, -0.22, 3.84, 3.34, -1.58, -0.42, 0.87, -0.18, -0.12, -1.62, -2.72, -4.18, -2.76, 2.11, 1.40, 4.02]);
  tana = new Tana(DI);
  ...
  return describe('BIAS', function() {
    it('has method BIAS', function() {
      return expect(tana.BIAS).toBeDefined();
    });
    it('has default value { period: 3 }', function() {
      return expect(tana.BIAS()).toEqual(tana.BIAS({
        period: 3
      }));
    });
    it('has correct answers', function() {
      return expect(tana.BIAS({
        period: 5
      })).toEqual(BIAS5);
    });
    return it('returns undefined when period is out of range', function() {
